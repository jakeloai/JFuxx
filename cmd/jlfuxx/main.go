...
func calibrateStatistical(client *http.Client, cfg *Config, template, target string) *StatisticalBaseline {
	...
	calibratePayloads := []string{
		"CALIBRATE_JLFuxx_001", "RANDOM_TEST_456_ABC", "NOT_EXIST_789_XYZ",
		"JLFuxx_CALIBRATE_123", "TEST_PAYLOAD_000_QWE", "CALIBRATE_JLFuxx_002",
		"RANDOM_TEST_789_DEF", "NOT_EXIST_123_GHI", "JLFuxx_CALIBRATE_456",
		"TEST_PAYLOAD_999_JKL", "CALIBRATE_JLFuxx_003", "RANDOM_TEST_111_MNO",
	}
...
func printSummary(r *Report) {
	fmt.Println("\n====================================================")
	fmt.Println("           JLFuxx Pro Scan Complete")
	fmt.Println("====================================================")
...
func printUsage() {
	fmt.Println("Usage:")
	fmt.Println("  jlfuxx -r request.txt -w wordlist.txt -u http://target.com")
	fmt.Println("")
	fmt.Println("Advanced Usage:")
	fmt.Println("  jlfuxx -r req.txt -w paths.txt -w params.txt -u http://target.com")
	fmt.Println("  jlfuxx -r req.txt -w dirs.txt -e .php -e .bak -e .old -fc 404")
	fmt.Println("  jlfuxx -r req.txt -w sqli.txt -acc -mt 3000 -o results")
	fmt.Println("  jlfuxx -r req.txt -w api.txt -rate 10 -jitter 0.5 -random-agent")
	fmt.Println("  jlfuxx -r req.txt -w dirs.txt -recursion -recursion-depth 2 -soft404")
	fmt.Println("")
	fmt.Println("Filters:")
